  ...
  <section class="container">
    <div class="row">
      <div class="col-lg-6 text-center" style="margin-bottom: 20px;">
        ...
        <a class="btn btn-lg btn-danger effect" style="color: white;" href="emrStatus.jsp">더보기</a>
      </div>
      <div class="col-lg-6 text-center" style="margin-bottom: 20px;">
        ...
        <a class="btn btn-lg btn-primary effect" style="color: white;" href="doctor.jsp">더보기</a>
      </div>
    </div>
    <div id="page3" class="row" style="margin-top: 50px; text-align: center;">
      <div class="col-lg-6 text-center" id="page3">
        ...
        <div class="col-lg-12 text-center">
          ...
          <a class="btn btn-lg btn-success effect" style="color: white;" href="congestion.jsp">더보기</a>
        </div>
      </div>
      <div class="col-lg-6 text-center pageInfo" id="page4">
        ...
        <ul class="col-lg-12 text-center">
          <div class="align-bottom">
            ...
            <a class="btn btn-lg effect" style="background: yellow; color: black;" href="person.jsp">더보기</a>
          </div>
        </ul>
      </div>
    </div>
